...
/***/ function(module, exports) {
	...
	class SoundCarousel{
	  ...
	  play() {
	    this.sounds[this.soundIndex % this.ns].volume = window.sfxVolume;
...
/***/ function(module, exports, __webpack_require__) {
	...
	class Aimbot {
	  ...
	  setStats(difficulty) {
	    this.gun.power = 2 + difficulty / 50;
	    this.fireInterval = 1000 - 5 * difficulty;
	    this.range = 350 + 4 * difficulty;
	  }
